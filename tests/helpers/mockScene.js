  ...
  const scene = {
    ...
    input: {
      keyboard: {
        ...
        addKeys: vi.fn(() => ({
          W: {}, A: { isDown: false }, S: {}, D: { isDown: false },
        })),
        on: vi.fn(),
      },
      gamepad: { gamepads: [] },
    ...
    cameras: {
      main: {
        ...
        scrollX: 0, scrollY: 0,
        setSize: vi.fn(), setBounds: vi.fn(),
        startFollow: vi.fn(), setBackgroundColor: vi.fn(),
      },
    },
    tweens: { add: vi.fn() },
    time: {
...
export function createMockElephant(sceneOverrides = {}) {
  ...
  return {
    ...
    keys: { W: {}, A: { isDown: false }, S: {}, D: { isDown: false } },
    groundContacts: 0,
    facing: 1,
    isDashing: false,
    celebrateTimer: 0,
